  ...
  return (
    <div className="w-full py-10">
      <ul className="grid grid-cols-1 gap-3">
        {data.map((user) => (
          <div className="relative rounded-lg bg-white p-3 pr-1 shadow transition-all hover:shadow-md dark:bg-slate-800 sm:p-4">
              ...
              <div className="relative flex shrink items-center space-x-2 sm:space-x-4">
                ...
                <div>
                  <div className="flex max-w-fit items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-1 rounded-md bg-gray-100 px-2 py-0.5 transition-all duration-75 hover:scale-105 active:scale-100">
                  ...
                  <h3 className="max-w-[200px] truncate text-sm font-medium text-neutral-600 dark:text-white md:max-w-md lg:max-w-2xl xl:max-w-3xl">
                    {`Joined on ${format(user.createdAt, "dd/MM/yyyy")}`}
                  </h3>
                </div>
              </div>
